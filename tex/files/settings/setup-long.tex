...
\usepackage{cite}
\usepackage[citestyle=ieee, bibstyle=ieee, style=numeric-comp, sorting=nty, maxbibnames=200]{biblatex}
...
% \usepackage[font=small,labelfont=bf,stretch=1]{caption}
...
\usepackage{titlesec}
\usepackage{apptools}
\AtAppendix{\titleformat{\chapter}{\LARGE\bfseries}{\appendixname~\thechapter:}{0.2em}{}%
...
% \hyphenation{djupinlärnings-tekniker}
% \hyphenation{djupinlärnings-modeller}
% Disable hyphenation
\pretolerance=9000
\tolerance=2000
