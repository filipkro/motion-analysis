...
\begin{frame}[fragile]{Postural Orientation Errors}
  \begin{columns}[T,onlytextwidth]
      ...
      \begin{figure}
        \raggedleft
        \includegraphics[angle=90,height=0.5\textheight]{files/figs/presentation/good-poe.png}
        % \caption{}
        % \label{}
      \end{figure}
      ...
      \begin{figure}
        \raggedright
        \includegraphics[angle=90,height=0.5\textheight]{files/figs/presentation/poor-poe.png}
        % \caption{}
        % \label{}
      \end{figure}
  \end{columns}
